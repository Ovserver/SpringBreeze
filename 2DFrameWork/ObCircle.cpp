...
void ObCircle::CreateStaticMember()
{
    ...
    for (UINT i = 0; i < 360; i++)
    {
        ...
        Vertex[i * 3+1].color = Color(0, 0, 0);
        Vertex[i * 3+2].color = Color(0, 0, 0);
    ...
    //    float idx = i / 120.0f;
    //    Vertex[i * 3].color = Color(1  - idx, idx, 0) * 1.5f;
    //    Vertex[i * 3+1].color = Color(1- idx, idx, 0) * 1.5f;
    //    Vertex[i * 3+2].color = Color(1- idx, idx, 0) * 1.5f;

    //}
    //for (UINT i = 120; i < 240; i++)
    //{
    //    Vertex[i * 3].position.x = 0.0f;
    //    Vertex[i * 3].position.y = 0.0f;
    //    //0 1 2 ... 359
    ...
    //    float idx = (i-120) / 120.0f;
    //    Vertex[i * 3].color = Color(0, 1-idx, idx) * 1.5f;
    //    Vertex[i * 3 + 1].color = Color(0, 1 - idx, idx) * 1.5f;
    //    Vertex[i * 3 + 2].color = Color(0, 1 - idx, idx) * 1.5f;
    //}
    //for (UINT i = 240; i < 360; i++)
    //{
    //    Vertex[i * 3].position.x = 0.0f;
    //    Vertex[i * 3].position.y = 0.0f;
    //    Vertex[i * 3 + 1].position.x = cosf(i * ToRadian) * 0.5f;
    ...
    //    float idx = (i - 240) / 120.0f;
    //    Vertex[i * 3].color = Color(idx, 0, 1- idx) * 1.5f;
    //    Vertex[i * 3 + 1].color = Color(idx, 0, 1 - idx) * 1.5f;
    //    Vertex[i * 3 + 2].color = Color(idx, 0, 1 - idx) * 1.5f;
    //}
...
void ObCircle::Render(Camera* cam)
{
    if (!isVisible)return;
