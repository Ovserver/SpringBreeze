...
void Main::Init()
{
	...
	GameManager::StageList[0]->AddEnemy(new Enemy(Vector2(150, -150), 10, L"waddleDoo_ouch.png"));
	GameManager::StageList[0]->AddEnemy(new Enemy(Vector2(280, -130), 10, L"waddleDoo_ouch.png"));
